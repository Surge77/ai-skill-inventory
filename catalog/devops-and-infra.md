...
|---|---|---|---|---|
| `access-protected-vercel-deployment` | Access and test Vercel deployments protected by Vercel Authentication, SSO, or Deployment Protection. Use when curl, agent-browser, Playwright, or another automated request reaches a Vercel… | vercel | claude-code | 1 files, 8 KB |
| `agency-best-devops` | Preferred daily-use DevOps specialist from the Agency set. Use for CI, deployment scripts, environment setup, process automation, release pipelines, and operational hardening. | agency-roles | codex | 1 files, 1 KB |
| `agency-engineering-devops-automator` | Agency agent wrapper for DevOps Automator. Expert DevOps engineer specializing in infrastructure automation, CI/CD pipeline development, and cloud operations | agency-roles | codex | 1 files, 13 KB |
| `agency-engineering-incident-response-commander` | Agency agent wrapper for Incident Response Commander. Expert incident commander specializing in production incident management, structured response coordination, post-mortem facilitation, S… | agency-roles | codex | 1 files, 21 KB |
| `agency-engineering-sre` | Agency agent wrapper for SRE (Site Reliability Engineer). Expert site reliability engineer specializing in SLOs, error budgets, observability, chaos engineering, and toil reduction for prod… | agency-roles | codex | 1 files, 4 KB |
| `agency-support-infrastructure-maintainer` | Agency agent wrapper for Infrastructure Maintainer. Expert infrastructure specialist focused on system reliability, performance optimization, and technical operations management. Maintains… | agency-roles | codex | 1 files, 22 KB |
| `book-sft-pipeline` | This skill should be used when the user asks to "fine-tune on books", "create SFT dataset", "train style model", "extract ePub text", or mentions style transfer, LoRA training, book segment… | agents-std-store | cline, continue, cursor, factory, kilocode, qwen-code, roo-code, shared-store, trae | 11 files, 659 KB |
| `context-mode` | Use context-mode tools (ctx_execute, ctx_execute_file) instead of Bash/cat when processing large outputs. Triggers: "analyze logs", "summarize output", "process data", "parse JSON", "filter… | context-mode | claude-code | 5 files, 52 KB |
| `cost-export` | Export cost-tracking telemetry in Prometheus textfile or webhook JSON formats — for external observability (Grafana, Datadog, custom dashboards) *(marketplace only)* | plugins | claude-code | 1 files, 3 KB |
| `datadog-cli` | Datadog CLI for searching logs, querying metrics, tracing requests, and managing dashboards. Use this when debugging production issues or working with Datadog observability. | agents-std-store | cline, continue, cursor, factory, kilocode, qwen-code, roo-code, shared-store, trae | 6 files, 19 KB |
| `deployment-patterns` | Deployment workflows, CI/CD pipeline patterns, Docker containerization, health checks, rollback strategies, and production readiness checklists for web applications. | ecc | claude-code | 1 files, 11 KB |
| `deployments-cicd` | Vercel deployment and CI/CD expert guidance. Use when deploying, promoting, rolling back, inspecting deployments, building with --prebuilt, or configuring CI workflow files for Vercel. | vercel | claude-code | 1 files, 12 KB |
| `deployments-cicd` | Vercel deployment and CI/CD expert guidance. Use when deploying, promoting, rolling back, inspecting deployments, building with --prebuilt, or configuring CI workflow files for Vercel. | vercel | codex | 2 files, 11 KB |
| `docker-patterns` | Docker and Docker Compose patterns for local development, container security, networking, volume strategies, and multi-service orchestration. | ecc | claude-code | 1 files, 8 KB |
| `email` | Email sending integration guidance — Resend (native Vercel Marketplace) with React Email templates. Covers API setup, transactional emails, domain verification, and template patterns. Use w… | vercel | codex | 2 files, 11 KB |
| `geistdocs` | Expert guidance for Geistdocs, Vercel's documentation template built with Next.js and Fumadocs — MDX authoring, configuration, AI chat, i18n, feedback, deployment. Use when creating documen… | vercel | codex | 2 files, 9 KB |
...
| `observability` | Vercel Observability expert guidance — Drains (logs, traces, speed insights, web analytics), Web Analytics, Speed Insights, runtime logs, custom events, OpenTelemetry integration, and monit… | vercel | codex | 2 files, 27 KB |
| `sign-in-with-vercel` | Sign in with Vercel guidance — OAuth 2.0/OIDC identity provider for user authentication via Vercel accounts. Use when implementing user login with Vercel as the identity provider. | vercel | codex | 2 files, 3 KB |
| `vercel-agent` | Vercel Agent guidance — AI-powered code review, incident investigation, and SDK installation. Automates PR analysis and anomaly debugging. Use when configuring or understanding Vercel's AI… | vercel | claude-code | 1 files, 3 KB |
...
| `vercel-storage` | Vercel storage expert guidance — Blob, Edge Config, and Marketplace storage (Neon Postgres, Upstash Redis). Use when choosing, configuring, or using data storage with Vercel applications. | vercel | codex | 2 files, 16 KB |
...
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.48.0/skills/access-protected-vercel-deployment` |
| Size | 1 files, 8 KB |
| SKILL.md | 170 lines, ~1,953 tokens |
| Description cost | ~105 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-09-02 |
| Category source | keywords |
| Content hash | `ce3317bd14a6` |

### `agency-best-devops`

Preferred daily-use DevOps specialist from the Agency set. Use for CI, deployment scripts, environment setup, process automation, release pipelines, and operational hardening.
...
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.codex/skills/agency-best-devops` |
| Size | 1 files, 1 KB |
...
| Category source | keywords |
| Content hash | `725f0197fce4` |

### `agency-engineering-devops-automator`

Agency agent wrapper for DevOps Automator. Expert DevOps engineer specializing in infrastructure automation, CI/CD pipeline development, and cloud operations
...
| Tools it reaches | codex |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.codex/skills/agency-engineering-devops-automator` |
| Size | 1 files, 13 KB |
| SKILL.md | 379 lines, ~3,284 tokens |
| Description cost | ~40 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-03-13 |
| Category source | keywords |
| Content hash | `04a5eb65dcae` |

### `agency-engineering-incident-response-commander`

Agency agent wrapper for Incident Response Commander. Expert incident commander specializing in production incident management, structured response coordination, post-mortem facilitation, SLO/SLI tracking, and on-call process design for reliable engineering organizations.
...
| Tools it reaches | codex |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.codex/skills/agency-engineering-incident-response-commander` |
| Size | 1 files, 21 KB |
| SKILL.md | 448 lines, ~5,403 tokens |
| Description cost | ~68 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-03-13 |
| Category source | keywords |
| Content hash | `2d9e8f62c65a` |

### `agency-engineering-sre`

Agency agent wrapper for SRE (Site Reliability Engineer). Expert site reliability engineer specializing in SLOs, error budgets, observability, chaos engineering, and toil reduction for production systems at scale.
...
| Tools it reaches | codex |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.codex/skills/agency-engineering-sre` |
| Size | 1 files, 4 KB |
| SKILL.md | 94 lines, ~1,040 tokens |
| Description cost | ~54 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-03-13 |
| Category source | keywords |
| Content hash | `9e6113102628` |

### `agency-support-infrastructure-maintainer`

Agency agent wrapper for Infrastructure Maintainer. Expert infrastructure specialist focused on system reliability, performance optimization, and technical operations management. Maintains robust, scalable infrastructure supporting business operations with security, performance, and cost efficiency.
...
| Tools it reaches | codex |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.codex/skills/agency-support-infrastructure-maintainer` |
| Size | 1 files, 22 KB |
| SKILL.md | 621 lines, ~5,663 tokens |
| Description cost | ~75 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-03-13 |
| Category source | keywords |
| Content hash | `5613f08725b9` |
...
| Canonical path | `~/.agents/skills/context-engineering-collection/examples/book-sft-pipeline` |
| Size | 11 files, 659 KB |
| SKILL.md | 381 lines, ~3,658 tokens |
| Description cost | ~56 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-02-11 |
| Category source | keywords |
| Content hash | `b1aadbdc49fc` |
| Bundled | `examples`, `references`, `scripts`, `gertrude-stein`, `pangram` |
...
| Canonical path | `~/.claude/plugins/cache/context-mode/context-mode/1.0.136/skills/context-mode` |
| Size | 5 files, 52 KB |
| SKILL.md | 301 lines, ~4,171 tokens |
| Description cost | ~237 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-05-18 |
| Category source | keywords |
| Content hash | `59c1c0d4aabd` |
| Bundled | `references` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/plugins/marketplaces/ruflo/plugins/ruflo-cost-tracker/skills/cost-export` |
| Size | 1 files, 3 KB |
| SKILL.md | 60 lines, ~706 tokens |
| Description cost | ~37 tokens always in context |
| Allowed tools | Bash |
| Model | — |
| Last modified | 2026-05-16 |
| Category source | keywords |
| Content hash | `a9ab18b8fcae` |
...
| Canonical path | `~/.agents/skills/datadog-cli` |
| Size | 6 files, 19 KB |
| SKILL.md | 128 lines, ~910 tokens |
| Description cost | ~44 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-02-11 |
| Category source | keywords |
| Content hash | `49972df9a216` |
| Bundled | `references` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/skills/ecc/deployment-patterns` |
| Size | 1 files, 11 KB |
| SKILL.md | 428 lines, ~2,857 tokens |
| Description cost | ~42 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-05-17 |
| Category source | keywords |
| Content hash | `b8b1aa3adcd2` |
...
| Tools it reaches | claude-code |
| Installed copies | 2 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.45.1/skills/deployments-cicd` |
| Size | 1 files, 12 KB |
| SKILL.md | 355 lines, ~3,032 tokens |
| Description cost | ~46 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-07-24 |
| Category source | keywords |
| Content hash | `12e99e4cccf2` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/skills/ecc/docker-patterns` |
| Size | 1 files, 8 KB |
| SKILL.md | 365 lines, ~2,154 tokens |
| Description cost | ~36 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-05-17 |
| Category source | keywords |
| Content hash | `5b1eb523684a` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/skills/ecc/github-ops` |
| Size | 1 files, 5 KB |
| SKILL.md | 145 lines, ~1,193 tokens |
| Description cost | ~82 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-05-17 |
| Category source | keywords |
| Content hash | `c25375804dda` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/skills/ecc/homelab-network-readiness` |
| Size | 1 files, 8 KB |
| SKILL.md | 170 lines, ~1,932 tokens |
| Description cost | ~42 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-05-17 |
| Category source | keywords |
| Content hash | `60dfa1b4d992` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/skills/ecc/homelab-network-setup` |
| Size | 1 files, 4 KB |
| SKILL.md | 130 lines, ~1,109 tokens |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/skills/ecc/mle-workflow` |
| Size | 1 files, 22 KB |
| SKILL.md | 347 lines, ~5,693 tokens |
| Description cost | ~57 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-05-17 |
| Category source | keywords |
| Content hash | `e40d68c8991b` |
...
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/.agents/skills/mle-workflow` |
| Size | 2 files, 23 KB |
| SKILL.md | 347 lines, ~5,703 tokens |
| Description cost | ~57 tokens always in context |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/skills/ecc/network-bgp-diagnostics` |
| Size | 1 files, 6 KB |
| SKILL.md | 168 lines, ~1,425 tokens |
| Description cost | ~37 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-05-17 |
| Category source | keywords |
| Content hash | `ea2cb39e899f` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/skills/ecc/network-config-validation` |
| Size | 1 files, 8 KB |
| SKILL.md | 211 lines, ~1,964 tokens |
| Description cost | ~50 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-05-17 |
| Category source | keywords |
| Content hash | `7114c272fbbb` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/skills/ecc/network-interface-health` |
| Size | 1 files, 6 KB |
| SKILL.md | 153 lines, ~1,451 tokens |
| Description cost | ~38 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-05-17 |
| Category source | keywords |
| Content hash | `c7e607fe206d` |
...
| Tools it reaches | claude-code |
| Installed copies | 2 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.45.1/skills/vercel-agent` |
| Size | 1 files, 3 KB |
| SKILL.md | 89 lines, ~753 tokens |
| Description cost | ~53 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-07-24 |
| Category source | keywords |
| Content hash | `12daa780df15` |
...
| Tools it reaches | claude-code |
| Installed copies | 2 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.45.1/skills/vercel-cli` |
| Size | 37 files, 78 KB |
| SKILL.md | 150 lines, ~1,519 tokens |
| Description cost | ~53 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-07-24 |
| Category source | keywords |
| Content hash | `fd3e71cba275` |
| Bundled | `command`, `references`, `upstream` |
...
| Tools it reaches | claude-code |
| Installed copies | 2 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.45.1/skills/vercel-cli/upstream` |
| Size | 18 files, 37 KB |
| SKILL.md | 67 lines, ~936 tokens |
| Description cost | ~17 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-07-24 |
| Category source | keywords |
| Content hash | `da21814dcac4` |
...
| Tools it reaches | claude-code |
| Installed copies | 2 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.45.1/skills/vercel-firewall` |
| Size | 1 files, 20 KB |
| SKILL.md | 372 lines, ~5,244 tokens |
| Description cost | ~78 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-07-24 |
| Category source | keywords |
| Content hash | `dae84ea8a652` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.45.1/skills/vercel-functions` |
| Size | 1 files, 22 KB |
| SKILL.md | 550 lines, ~5,699 tokens |
| Description cost | ~56 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-07-24 |
| Category source | keywords |
| Content hash | `9447920e7fba` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.48.0/skills/vercel-functions` |
| Size | 1 files, 22 KB |
| SKILL.md | 550 lines, ~5,694 tokens |
| Description cost | ~56 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-09-02 |
| Category source | keywords |
| Content hash | `e4cbbfb7d890` |
...
| Tools it reaches | claude-code |
| Installed copies | 2 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.45.1/skills/vercel-sandbox` |
| Size | 3 files, 24 KB |
| SKILL.md | 370 lines, ~3,035 tokens |
| Description cost | ~55 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-07-24 |
| Category source | keywords |
| Content hash | `00c468b6253e` |
| Bundled | `upstream` |
...
| Tools it reaches | claude-code |
| Installed copies | 2 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.45.1/skills/vercel-sandbox/upstream` |
| Size | 1 files, 10 KB |
| SKILL.md | 281 lines, ~2,488 tokens |
| Description cost | ~137 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-07-24 |
| Category source | keywords |
| Content hash | `27b86e0b3820` |
...
| Tools it reaches | claude-code |
| Installed copies | 1 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.48.0/skills/vercel-services` |
| Size | 1 files, 11 KB |
| SKILL.md | 243 lines, ~2,779 tokens |
| Description cost | ~79 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-09-02 |
| Category source | keywords |
| Content hash | `57b4861d8478` |
...
| Tools it reaches | claude-code |
| Installed copies | 2 (0 symlinked) |
| Canonical path | `~/.claude/plugins/cache/claude-plugins-official/vercel/0.45.1/skills/vercel-storage` |
| Size | 1 files, 20 KB |
| SKILL.md | 527 lines, ~5,093 tokens |
| Description cost | ~48 tokens always in context |
| Allowed tools | — |
| Model | — |
| Last modified | 2026-07-24 |
| Category source | keywords |
| Content hash | `885d05536cfd` |
