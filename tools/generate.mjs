...
- [\`registry/\`](registry/README.md) — every skill published in those repos, installed or not, so the shelf stays searchable when one is needed later. Generated by \`npm run refresh:remote\`.
